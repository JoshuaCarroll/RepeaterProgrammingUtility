...
namespace Repeater_Programming_Utility
{
    public partial class Form1 : Form
    {
		...
		private void sSHModeToolStripMenuItem_Click(object sender, EventArgs e)
		{
			groupBoxSecurity.Visible = !sSHModeToolStripMenuItem.Checked;
			groupBoxSecurity.Visible = !sSHModeToolStripMenuItem.Checked;
			groupBoxTone.Visible = !sSHModeToolStripMenuItem.Checked;
		}
	}
}